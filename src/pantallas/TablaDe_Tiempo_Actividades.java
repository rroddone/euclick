 ...
 * @author Lenovo
 */
public class TablaDe_Tiempo_Actividades extends javax.swing.JFrame {
    ...
    public TablaDe_Tiempo_Actividades() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Tabla de Tiempo Actividades");
...
"join estado e on e.id_estado = a.id_estado ";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaDe_Tiempo_Actividades().setVisible(true);
            }
