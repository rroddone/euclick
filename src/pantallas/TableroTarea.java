 ...
 * @author user
 */
public class TableroTarea extends javax.swing.JFrame {
    
    public TableroTarea() throws Exception {
        initComponents();
        try{
            ...
            String sql = "select nombre_tarea, fecha_inicio, fecha_limite  from tarea a where id_estado = 1";
        ...
        try{
            ...
            String sql = "select nombre_tarea, fecha_inicio, fecha_limite  from tarea where id_estado = 2";
            ResultSet rs = st.executeQuery(sql);
        ...
        try{
            ...
            String sql = "select nombre_tarea, fecha_inicio, fecha_limite  from tarea a where id_estado = 3";
            ResultSet rs = st.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        btnaggacti.setText("+ Agregar Tarea");
        ...
        content.setBounds(850, 190, 760, 450);
        ...
        jButton2.setText("Volver a acciones");
        ...
        jButton2.setBounds(670, 210, 140, 22);
    ...
    private void btnaggactiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaggactiActionPerformed
        Agregar_Tarea newTarea = null;
        try {
            newTarea = new Agregar_Tarea();
        } catch (Exception ex) {
            Logger.getLogger(TableroTarea.class.getName()).log(Level.SEVERE, null, ex);
        }
        newTarea.setSize(544,345);
        newTarea.setLocation(0,0);
        
        content.removeAll();
        content.add(newTarea, BorderLayout.CENTER);
        content.revalidate();
        content.repaint();
    }//GEN-LAST:event_btnaggactiActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Agregar_Tarea AT = null;
        try {
            AT = new Agregar_Tarea();
        } catch (Exception ex) {
            Logger.getLogger(TableroTarea.class.getName()).log(Level.SEVERE, null, ex);
        }
        AT.setSize(690,358);
        ...
        content.removeAll();
        content.add(AT, BorderLayout.CENTER);
        content.revalidate();
        content.repaint();
